...
entity reconstruct_fifo_w64_d7_S is 
    generic (
...
architecture rtl of reconstruct_fifo_w64_d7_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component reconstruct_fifo_w64_d7_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 7);
...
begin
----------------------- Instantiation -----------------------
    U_reconstruct_fifo_w64_d7_S_ShiftReg : reconstruct_fifo_w64_d7_S_ShiftReg
    generic map (
...
entity reconstruct_fifo_w64_d7_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 7);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end reconstruct_fifo_w64_d7_S_ShiftReg;

architecture rtl of reconstruct_fifo_w64_d7_S_ShiftReg is
