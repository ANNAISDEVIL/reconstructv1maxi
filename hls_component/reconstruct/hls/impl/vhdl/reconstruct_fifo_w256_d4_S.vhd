...
entity reconstruct_fifo_w256_d4_S is 
    generic (
...
architecture rtl of reconstruct_fifo_w256_d4_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component reconstruct_fifo_w256_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_reconstruct_fifo_w256_d4_S_ShiftReg : reconstruct_fifo_w256_d4_S_ShiftReg
    generic map (
...
entity reconstruct_fifo_w256_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end reconstruct_fifo_w256_d4_S_ShiftReg;

architecture rtl of reconstruct_fifo_w256_d4_S_ShiftReg is
