...
define internal fastcc void @copy_in([1024 x %struct.atom_location]* readonly, [1024 x %struct.atom_location]*, [100000 x float]* readonly, [100000 x float]*, [100 x float]* readonly, [100 x float]* align 512, [100 x i32]* readonly, [100 x i32]* align 512, [65536 x float]* readonly, [65536 x float]*, [1024 x float]* readonly, [1024 x float]*) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a65536f32([65536 x float]* %dst, [65536 x float]* readonly %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([1024 x %struct.atom_location]*, [1024 x %struct.atom_location]* readonly, [100000 x float]*, [100000 x float]* readonly, [100 x float]*, [100 x float]* readonly align 512, [100 x i32]*, [100 x i32]* readonly align 512, [65536 x float]*, [65536 x float]* readonly, [1024 x float]*, [1024 x float]* readonly) unnamed_addr #4 {
entry:
...
declare void @apatb_reconstruct_hw(i32, i32, i32, [1024 x %struct.atom_location]*, i32, i32, [100000 x float]*, [100 x float]*, [100 x i32]*, [65536 x float]*, i32, i32, [1024 x float]*)
...
define void @reconstruct_hw_stub_wrapper(i32, i32, i32, [1024 x %struct.atom_location]*, i32, i32, [100000 x float]*, [100 x float]*, [100 x i32]*, [65536 x float]*, i32, i32, [1024 x float]*) #5 {
entry:
  call void @copy_out([1024 x %struct.atom_location]* null, [1024 x %struct.atom_location]* %3, [100000 x float]* null, [100000 x float]* %6, [100 x float]* null, [100 x float]* %7, [100 x i32]* null, [100 x i32]* %8, [65536 x float]* null, [65536 x float]* %9, [1024 x float]* null, [1024 x float]* %12)
  ...
  %17 = bitcast [65536 x float]* %9 to float*
  ...
  call void @copy_in([1024 x %struct.atom_location]* null, [1024 x %struct.atom_location]* %3, [100000 x float]* null, [100000 x float]* %6, [100 x float]* null, [100 x float]* %7, [100 x i32]* null, [100 x i32]* %8, [65536 x float]* null, [65536 x float]* %9, [1024 x float]* null, [1024 x float]* %12)
  ret void
}
