...
define void @apatb_reconstruct_ir(i32 %atomLocationsSize, i32 %projShape0, i32 %projShape1, %struct.atom_location* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" "maxi" %atomLocations, i32 %psfSupersample, i32 %imageProjectionSize, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1048576" "maxi" %imageProjs_local, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" "maxi" %imageProjs, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" "maxi" %imageProjs_local_size, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="589824" "maxi" %fullImage, i32 %fullImage_rows, i32 %fullImage_cols, float* noalias nocapture nonnull "maxi" %emissions) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast float* %imageProjs_local to [1048576 x float]*
  %3 = call i8* @malloc(i64 4194304)
  %imageProjs_local_copy = bitcast i8* %3 to [1048576 x float]*
  %4 = bitcast float* %imageProjs to [1024 x float]*
  %5 = call i8* @malloc(i64 4096)
  %imageProjs_copy = bitcast i8* %5 to [1024 x float]*
  %6 = bitcast i32* %imageProjs_local_size to [1024 x i32]*
  %7 = call i8* @malloc(i64 4096)
  %imageProjs_local_size_copy = bitcast i8* %7 to [1024 x i32]*
  %8 = bitcast float* %fullImage to [589824 x float]*
  %9 = call i8* @malloc(i64 2359296)
  %fullImage_copy = bitcast i8* %9 to [589824 x float]*
  %10 = bitcast float* %emissions to [1024 x float]*
  %11 = call i8* @malloc(i64 4096)
  %emissions_copy = bitcast i8* %11 to [1024 x float]*
  call fastcc void @copy_in([1024 x %struct.atom_location]* nonnull %0, [1024 x %struct.atom_location]* %atomLocations_copy, [1048576 x float]* nonnull %2, [1048576 x float]* %imageProjs_local_copy, [1024 x float]* nonnull %4, [1024 x float]* %imageProjs_copy, [1024 x i32]* nonnull %6, [1024 x i32]* %imageProjs_local_size_copy, [589824 x float]* nonnull %8, [589824 x float]* %fullImage_copy, [1024 x float]* nonnull %10, [1024 x float]* %emissions_copy)
  call void @apatb_reconstruct_hw(i32 %atomLocationsSize, i32 %projShape0, i32 %projShape1, [1024 x %struct.atom_location]* %atomLocations_copy, i32 %psfSupersample, i32 %imageProjectionSize, [1048576 x float]* %imageProjs_local_copy, [1024 x float]* %imageProjs_copy, [1024 x i32]* %imageProjs_local_size_copy, [589824 x float]* %fullImage_copy, i32 %fullImage_rows, i32 %fullImage_cols, [1024 x float]* %emissions_copy)
  call void @copy_back([1024 x %struct.atom_location]* %0, [1024 x %struct.atom_location]* %atomLocations_copy, [1048576 x float]* %2, [1048576 x float]* %imageProjs_local_copy, [1024 x float]* %4, [1024 x float]* %imageProjs_copy, [1024 x i32]* %6, [1024 x i32]* %imageProjs_local_size_copy, [589824 x float]* %8, [589824 x float]* %fullImage_copy, [1024 x float]* %10, [1024 x float]* %emissions_copy)
...
define internal fastcc void @copy_in([1024 x %struct.atom_location]* readonly, [1024 x %struct.atom_location]*, [1048576 x float]* readonly, [1048576 x float]*, [1024 x float]* readonly, [1024 x float]*, [1024 x i32]* readonly, [1024 x i32]*, [589824 x float]* readonly, [589824 x float]*, [1024 x float]* readonly, [1024 x float]*) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a589824f32([589824 x float]* %9, [589824 x float]* %8)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a1048576f32([1048576 x float]* %dst, [1048576 x float]* readonly %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a589824f32([589824 x float]* %dst, [589824 x float]* readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [589824 x float]* %dst, null
  %1 = icmp eq [589824 x float]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a589824f32([589824 x float]* nonnull %dst, [589824 x float]* nonnull %src, i64 589824)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a589824f32([589824 x float]* %dst, [589824 x float]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [589824 x float]* %src, null
  %1 = icmp eq [589824 x float]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [589824 x float], [589824 x float]* %dst, i64 0, i64 %for.loop.idx2
  %src.addr = getelementptr [589824 x float], [589824 x float]* %src, i64 0, i64 %for.loop.idx2
  %3 = load float, float* %src.addr, align 4
  store float %3, float* %dst.addr, align 4
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([1024 x %struct.atom_location]*, [1024 x %struct.atom_location]* readonly, [1048576 x float]*, [1048576 x float]* readonly, [1024 x float]*, [1024 x float]* readonly, [1024 x i32]*, [1024 x i32]* readonly, [589824 x float]*, [589824 x float]* readonly, [1024 x float]*, [1024 x float]* readonly) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a589824f32([589824 x float]* %8, [589824 x float]* %9)
...
declare void @apatb_reconstruct_hw(i32, i32, i32, [1024 x %struct.atom_location]*, i32, i32, [1048576 x float]*, [1024 x float]*, [1024 x i32]*, [589824 x float]*, i32, i32, [1024 x float]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([1024 x %struct.atom_location]*, [1024 x %struct.atom_location]* readonly, [1048576 x float]*, [1048576 x float]* readonly, [1024 x float]*, [1024 x float]* readonly, [1024 x i32]*, [1024 x i32]* readonly, [589824 x float]*, [589824 x float]* readonly, [1024 x float]*, [1024 x float]* readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1024f32([1024 x float]* %10, [1024 x float]* %11)
  ret void
}
...
define void @reconstruct_hw_stub_wrapper(i32, i32, i32, [1024 x %struct.atom_location]*, i32, i32, [1048576 x float]*, [1024 x float]*, [1024 x i32]*, [589824 x float]*, i32, i32, [1024 x float]*) #5 {
entry:
  call void @copy_out([1024 x %struct.atom_location]* null, [1024 x %struct.atom_location]* %3, [1048576 x float]* null, [1048576 x float]* %6, [1024 x float]* null, [1024 x float]* %7, [1024 x i32]* null, [1024 x i32]* %8, [589824 x float]* null, [589824 x float]* %9, [1024 x float]* null, [1024 x float]* %12)
  %13 = bitcast [1024 x %struct.atom_location]* %3 to %struct.atom_location*
  %14 = bitcast [1048576 x float]* %6 to float*
  %15 = bitcast [1024 x float]* %7 to float*
  %16 = bitcast [1024 x i32]* %8 to i32*
  %17 = bitcast [589824 x float]* %9 to float*
  %18 = bitcast [1024 x float]* %12 to float*
  ...
  call void @copy_in([1024 x %struct.atom_location]* null, [1024 x %struct.atom_location]* %3, [1048576 x float]* null, [1048576 x float]* %6, [1024 x float]* null, [1024 x float]* %7, [1024 x i32]* null, [1024 x i32]* %8, [589824 x float]* null, [589824 x float]* %9, [1024 x float]* null, [1024 x float]* %12)
  ret void
}
