...
entity reconstruct_ap_bound is 
    generic (
...
architecture rtl of reconstruct_ap_bound is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component reconstruct_ap_bound_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_reconstruct_ap_bound_ShiftReg : reconstruct_ap_bound_ShiftReg
    generic map (
...
entity reconstruct_ap_bound_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end reconstruct_ap_bound_ShiftReg;

architecture rtl of reconstruct_ap_bound_ShiftReg is
