...
HLS_SOURCES = ../../../../../test.cpp ../../../../../image_analysis.cpp

override TARGET := csim.exe

AUTOPILOT_ROOT := F:/Vitis/2024.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := F:/Vitis/2024.2/tps/win64/msys64/mingw64/bin
endif
...
CCFLAG += --sysroot=F:/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
CCFLAG += -Werror=uninitialized
CCFLAG += -Wno-c++11-narrowing
CCFLAG += -Wno-error=sometimes-uninitialized
LFLAG += --sysroot=F:/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/image_analysis.o: ../../../../../image_analysis.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../image_analysis.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/image_analysis.d
